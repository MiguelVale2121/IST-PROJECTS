...
void mml::xml_writer::do_function_type_node(mml::function_type_node *const node, int lvl)
{
  // EMPTY
}
...
void mml::xml_writer::do_memory_address_node(mml::memory_address_node *const node, int lvl)
{
  // EMPTY
}
