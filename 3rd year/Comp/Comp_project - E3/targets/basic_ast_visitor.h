...
private:
  ...
  std::shared_ptr<std::vector<bool>> _function_reference_hint;
...
public:
  ...
  std::shared_ptr<std::vector<bool>> function_reference_hints()
  {
    return _function_reference_hint;
  }

  void set_function_reference_hints(std::shared_ptr<std::vector<bool>> function_reference_hint)
  {
    _function_reference_hint = function_reference_hint;
  }
