...
void mml::frame_size_calculator::do_indexing_ptr_node(mml::indexing_ptr_node *const node, int lvl)
{
  // EMPTY
}
...
void mml::frame_size_calculator::do_memory_alloc_node(mml::memory_alloc_node *const node, int lvl)
{
  // EMPTY
}
