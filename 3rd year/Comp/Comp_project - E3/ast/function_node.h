...
namespace mml
{
    ...
    public:
        inline function_node(int lineno, cdk::sequence_node *params, std::shared_ptr<cdk::basic_type> funType, mml::block_node *block) : cdk::expression_node(lineno), _params(params), _block(block)
        {
            type(funType);
        }
    ...
    public:
        ...
        inline void setTypeChecked()
        {
            _typeChecked = true;
        }

        inline bool typeChecked()
        {
            return _typeChecked;
        }
