...
program	: tBEGIN block_instr tEND { $$ = new mml::program_node(LINE, $2); }
	     ;
...
top_var_decl : tPUBLIC var_decl                   { $$ = new mml::declaration_node(LINE, false, false, true, $2->isAuto(), $2->type(), $2->identifier(), $2->expression()); }
             | tPUBLIC tIDENTIFIER '=' expr       { $$ = new mml::declaration_node(LINE, false, false, true, false, cdk::primitive_type::create(0, cdk::typename_type::TYPE_UNSPEC), *$2, $4); delete $2; }
